...
//! For this example we are reading the first 3 pins of the gpio bank 0 and blink the pico led for each `1` we reed.
//! if you ground pysically any of these pins then you will read a 0 and the led will not blink.
//!
//!
